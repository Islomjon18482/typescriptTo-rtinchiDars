...
function App() {
  ...
  function formValidate(company: string, email: string, tel: string, country: string, city: string, address: string, num: number
  ) {
  ...
  function heandleClick(){
    if(formValidate(companyRef.current?.value || '', emailRef.current?.value || '', telRef.current?.value || '', countryRef.current?.value || '', cityRef.current?.value || '', addresRef.current?.value || '', parseFloat(numRef.current?.value || ""))){
  ...
  return (
    <div className="form">
      ...
      <div className="file">
        <img src="./circle.svg" />
        <label htmlFor="file-input" className="file_input_label">
          {" "}
          Yuklash
        </label>
        <input id="file-input" type="file" className="file__input" />
      </div>
      <div className="inputs">
        ...
        <div className="tel">
          <label>
            ...
            <input ref={telRef} type="text" placeholder="UZ +9989" />
          </label>
        </div>
        <div className="links">
          <p>Linklar</p>
        ...
        <div className="row">
          <div className="country">
            <label>
              ...
              <input ref={countryRef} type="text" placeholder="Davlat" />
            </label>
          </div>
          <div className="city">
            <label>
              ...
              <input ref={cityRef} type="text" placeholder="Shahar" />
            </label>
          </div>
        </div>
        <div className="adress">
          <label>
            ...
            <input ref={addresRef} type="text" placeholder="Joy" />
          </label>
        </div>
        <div className="num">
          <label>
            ...
            <input ref={numRef} type="number" placeholder="Hodimlar soni" />
          </label>
        </div>
        <div className="desc">
          <label>
      ...
      <div className="btns">
        <button className="cencel">ORTGA</button>
        <button onClick={heandleClick} className="letter">KEYINGISI</button>
      </div>
    </div>
  );
}
